...
def calc_intersection_and_extrapolate_policy(
    wealth_1_lower_curve: jnp.ndarray, #float | jnp.ndarray,
    value_1_lower_curve: jnp.ndarray, #float | jnp.ndarray,
    policy_1_lower_curve: jnp.ndarray, #float | jnp.ndarray,
    wealth_2_lower_curve: jnp.ndarray, #float | jnp.ndarray,
    value_2_lower_curve: jnp.ndarray, #float | jnp.ndarray,
    policy_2_lower_curve: jnp.ndarray, #float | jnp.ndarray,
    wealth_1_upper_curve: jnp.ndarray, #float | jnp.ndarray,
    value_1_upper_curve: jnp.ndarray, #float | jnp.ndarray,
    policy_1_upper_curve: jnp.ndarray, #float | jnp.ndarray,
    wealth_2_upper_curve: jnp.ndarray, #float | jnp.ndarray,
    value_2_upper_curve: jnp.ndarray, #float | jnp.ndarray,
    policy_2_upper_curve: jnp.ndarray, #float | jnp.ndarray,
):
